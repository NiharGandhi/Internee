      ...
      <div className="flex flex-col min-h-[100dvh]">
          <header className="px-4 lg:px-6 h-14 flex items-center">
              <Link className="flex items-center justify-center" href="#">
                  ...
                  <span className="sr-only">Internee</span>
              </Link>
          ...
          <main className="flex-1">
                      ...
                      <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
                          <div className="flex flex-col justify-center space-y-4">
                              ...
                              <div className="flex flex-col gap-2 min-[400px]:flex-row">
                                  ...
                                  <Link
                                      className="inline-flex h-10 items-center justify-center rounded-md border border-[#6c5ce7] border-[#6c5ce7] bg-white px-8 text-sm font-medium shadow-sm transition-colors hover:bg-gray-100 hover:text-[#6c5ce7] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#6c5ce7] disabled:pointer-events-none disabled:opacity-50 dark:border-[#6c5ce7] dark:border-[#6c5ce7] dark:bg-gray-950 dark:hover:bg-[#6c5ce7]/20 dark:hover:text-gray-50 dark:focus-visible:ring-[#6c5ce7]"
                                      href="/dashboard"
                                  >
                                      Dashboard
                                  </Link>
              ...
              <section className="w-full py-12 md:py-24 lg:py-32 bg-[#f4f4f4] dark:bg-gray-800">
